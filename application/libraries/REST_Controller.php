...
abstract class REST_Controller extends CI_Controller
{
    ...
    */
    ...
    public function _remap($object_called, $arguments)
    {
        ...
        //log_message('error', $controller_method);
    ...
    protected function _check_limit($controller_method)
    {
        ...
        if ( ! empty($this->rest->ignore_limits) or !isset($this->methods[$controller_method]['limit'])) {
            ...
            log_message('error', 'check limit: '.!isset($this->methods[$controller_method]['limit']));
            return true;
        }
    ...
    protected function _check_access()
    {
        ...
        //log_message('error', 'Controller:'.var_export($controller,TRUE));
